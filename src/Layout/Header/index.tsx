...
export default function Header() {
	...
	return (
		<div
			...
			<header className="mx-auto w-[calc(100%-2rem)] max-w-5xl bg-white/90 bg-blur-3xl backdrop-blur-sm shadow-md flex items-center justify-between px-4 my-4 rounded-full md:px-8">
