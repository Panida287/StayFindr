...
/**
 * Promotional banner component used on the homepage to highlight offers.
 * Displays a background image with heading, description, and CTA button.
 */
export default function AdBanner() {
	return (
		<section
			aria-label="Promotional summer offer"
		...
		>
			...
			{/* Content */}
			<div className="relative z-20 h-full flex flex-col justify-center items-start px-6 text-white md:px-12 transition-opacity duration-500">
