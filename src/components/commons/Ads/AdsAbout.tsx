...
const AdsAbout: React.FC = () => {
	return (
		<section className="relative w-full mt-4 max-w-5xl mx-auto flex flex-col-reverse items-center p-6 md:flex-row">
			<div className="w-full md:w-1/2 space-y-4">
				...
				<p className="text-primary indent-10 text-sm">
					...
					perfect stay,
					whether for business or vacation. Enjoy a seamless experience with handpicked hotels, great deals,
					and 24/7 support.
				</p>
				<SplitButton
					to="/about"
			...
			<div className="w-full flex justify-center md:justify-end gap-4 mb-6 md:mb-0 md:w-1/2 ">
				<div className="space-y-4">
					<div className="relative">
						...
						/>
						<span
							className="absolute inset-2 border border-secondary/50 rounded-md pointer-events-none"></span>
					</div>
					<div className="relative">
						<img
				...
				<div className="relative">
					...
					/>
					<span className="absolute inset-2 border border-secondary/50 rounded-md pointer-events-none"></span>
				</div>
			</div>
